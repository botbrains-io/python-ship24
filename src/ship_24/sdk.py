...
import httpx
import importlib
from ship_24 import models, utils
from ship_24._hooks import SDKHooks
from ship_24.types import OptionalNullable, UNSET
from typing import Any, Callable, Dict, Optional, TYPE_CHECKING, Union, cast
import weakref

if TYPE_CHECKING:
    from ship_24.api_for_per_call_plans import APIForPerCallPlans
    from ship_24.couriers import Couriers
    from ship_24.trackers import Trackers
...
class Ship24(BaseSDK):
    ...
    """
    _sub_sdk_map = {
        "trackers": ("ship_24.trackers", "Trackers"),
        "couriers": ("ship_24.couriers", "Couriers"),
        "api_for_per_call_plans": (
            "ship_24.api_for_per_call_plans",
            "APIForPerCallPlans",
        ),
    }
