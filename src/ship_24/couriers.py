...
from ship_24 import errors, models, utils
from ship_24._hooks import HookContext
from ship_24.types import OptionalNullable, UNSET
from ship_24.utils import get_security_from_env
from typing import Any, Mapping, Optional


class Couriers(BaseSDK):
    def get_couriers(
        self,
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetCouriersResponse(
                result=utils.unmarshal_json_response(
                    models.GetCouriersResponseBody, http_res
                ),
                headers={},
            )
